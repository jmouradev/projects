...
class EstacionamentoNaoIdentificadosList extends React.Component {
    state = {
        lista: [],
        estado: 'carregando',
        msgErro: null
    ...
    get_list = () => {
        const dadosIn = { opcao: 'list_not_identified', dados: null };
                ...
                <Paper className={classes.root}>
                    {estado === 'carregando' ? (
                        ...
                        <div className={classes.body}>
                            <h2>Estacionamentos não identificados</h2>
...
EstacionamentoNaoIdentificadosList.propTypes = {
    classes: PropTypes.object.isRequired,
    loginData: PropTypes.object
};

export default withStyles(styles)(EstacionamentoNaoIdentificadosList);
