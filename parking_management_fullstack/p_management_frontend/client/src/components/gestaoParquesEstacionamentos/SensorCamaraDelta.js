...
class ZonaPoints extends Component {
    ...
    montaCirculos = () => {
        ...
        if (
            ...
            const imageDelta = this.refs.imageDelta;
            ctx.drawImage(imageDelta, 0, 0, 300, 300);
    ...
    reload_vagas = event => {
        ...
        fetch_server('/vaga', dadosIn, dadosOut => {
            if (dadosOut.err) {
                ...
                imageDelta.onload = () => {
                    this.setState({ imageDelta: true, isMontarRetangulos: true });
                };
    ...
    load_image = () => {
        ...
        fetch_server('/zona', dadosIn, dadosOut => {
            ...
            if (dadosOut.err) this.setState({ estado: 'erro', msgErro: dadosOut.err, imageDelta: true });
    ...
    setMarker = map => {
        const uluru = { lat: 38.756269, lng: -9.115615 };
    ...
    render() {
        ...
        const mapOptions = { zoom: 30, center: { lat: 38.756269, lng: -9.115615 }, mapTypeId: 'satellite' };
        ...
        return (
            <div className={classes.paper}>
                <div>
                    <img ref='imageDelta' src={this.state.image} className='hidden' alt='' />
