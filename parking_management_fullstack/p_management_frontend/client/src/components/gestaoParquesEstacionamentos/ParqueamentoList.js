...
import ParqueamentoForm from './ParqueamentoForm';
...
class ParqueamentoList extends React.Component {
    state = {
        lista: [],
        estado: 'carregando',
        msgErro: null,
    ...
    getList = () => {
        const dadosIn = { opcao: 'list_curday', dados: null };
...
ParqueamentoList.propTypes = {
    classes: PropTypes.object.isRequired,
    loginData: PropTypes.object
};

export default withStyles(styles)(ParqueamentoList);
